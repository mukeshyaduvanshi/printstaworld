            ...
            <div className="mb-5 pt-5">
                ...
                <div className="my-5 grid grid-cols-1 gap-8 font-bold lg:grid-cols-2">
                    <div>
                        ...
                        <span className="rounded-sm border border-white-light px-2 py-1 text-dark dark:border-dark dark:text-white-dark" id="nouiMin2Perc">
                            {`${parseInt(percent2[0])}%`}
                        </span>
                    </div>
                    <div className="ltr:text-right rtl:text-left">
                        ...
                        <span className="rounded-sm border border-white-light px-2 py-1 text-dark dark:border-dark dark:text-white-dark" id="nouiMax2Perc">
                            {`${parseInt(percent2[1])}%`}
                        </span>
                    </div>
                </div>
