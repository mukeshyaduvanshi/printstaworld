...
<div className="mb-5">
    <div className="border border-[#d3d3d3] dark:border-[#3b3f5c] rounded-sm font-semibold">
        ...
        >
            <div className="mb-5">
                <div className="rounded-sm border border-[#d3d3d3] font-semibold dark:border-[#3b3f5c]">
                    <div className="border-b border-[#d3d3d3] dark:border-[#3b3f5c]">
