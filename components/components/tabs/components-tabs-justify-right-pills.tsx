                ...
                <Tab as={Fragment}>
                    {({ selected }) => (
                        <div className="flex-auto text-center outline-hidden!">
                            <button
                                className={\`\${selected ? 'bg-info text-white outline-hidden!' : ''}  -mb-[1px] block rounded-sm p-3.5 py-2 hover:bg-info hover:text-white\`}>
                                Home
                            </button>
                        </div>
                    )}
                                ...
                                {({ selected }) => (
                                    <button
                                        className={`${selected ? 'bg-info text-white outline-hidden!' : ''}
                                                    ' -mb-[1px] block rounded-sm p-3.5 py-2 hover:bg-info hover:text-white`}
                                    >
                                        Home
                                    </button>
                                )}
