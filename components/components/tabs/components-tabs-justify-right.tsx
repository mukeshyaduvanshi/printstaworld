                ...
                <Tab as={Fragment}>
                    {({ selected }) => (
                        <div className="flex-auto text-center outline-hidden!">
                            <button
                                className={\`\${selected ? 'border-white-light! border-b-white! text-primary outline-hidden! dark:border-[#191e3a]! dark:border-b-black!' : ''}  -mb-[1px] block border border-transparent p-3.5 py-2 hover:border-white-light hover:border-b-white dark:hover:border-[#191e3a] dark:hover:border-b-black\`}>
                                Home
                            </button>
                        </div>
                    )}
