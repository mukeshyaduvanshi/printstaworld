...
<Tab.Group>
    <Tab.List className="mt-3 flex flex-wrap">
        ...
        <Tab className="pointer-events-none -mb-[1px] block rounded-sm p-3.5 py-2 text-white-light dark:text-dark">Disabled</Tab>
    </Tab.List>
</Tab.Group>
<Tab.Panels>
    <Tab.Panel>
                        ...
                        <Tab.List className="mt-3 flex flex-wrap">
                            <Tab as={Fragment}>
                                {({ selected }) => (
                                    <button
                                        className={`${selected ? 'bg-primary text-white outline-hidden!' : ''}
                                                    ' -mb-[1px] block rounded-sm p-3.5 py-2 hover:bg-primary hover:text-white ltr:mr-2 rtl:ml-2`}
                                    >
                                        Home
                                    </button>
                                )}
                            ...
                            <Tab as={Fragment}>
                                {({ selected }) => (
                                    <button
                                        className={`${selected ? 'bg-primary text-white outline-hidden!' : ''} -mb-[1px] block rounded-sm p-3.5 py-2 hover:bg-primary hover:text-white ltr:mr-2 rtl:ml-2`}
                                    >
                                        Profile
                                    </button>
                                )}
