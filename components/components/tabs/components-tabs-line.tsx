...
<Tab.Group>
    <Tab.List className="mt-3 flex flex-wrap">
        <Tab as={Fragment}>
            {({ selected }) => (
                <button
                    className={\`\${selected ? 'border-b border-secondary! text-secondary outline-hidden!' : ''} -mb-[1px] flex items-center border-transparent p-5 py-3 before:inline-block hover:border-b hover:border-secondary! hover:text-secondary\`}>
                    <svg>...</svg>
                    Home
                </button>
            )}
