...
<Tab.Group>
    <Tab.List className="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
        <Tab as={Fragment}>
            {({ selected }) => (
                <button
                    className={\`\${selected ? 'border-white-light! border-b-white! text-danger dark:border-[#191e3a]! dark:border-b-black!' : ''} p-3.5 py-2 -mb-[1px] flex items-center border border-transparent hover:text-danger outline-hidden! transition duration-300\`}>
                    <svg>...</svg>
                    Home
                </button>
            )}
                                ...
                                {({ selected }) => (
                                    <button
                                        className={`${selected ? 'border-white-light! border-b-white! text-danger dark:border-[#191e3a]! dark:border-b-black!' : ''}
                                                -mb-[1px] flex items-center border border-transparent p-3.5 py-2 outline-hidden! transition duration-300 hover:text-danger`}
                                    >
