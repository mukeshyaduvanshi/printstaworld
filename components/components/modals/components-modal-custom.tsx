                                    ...
                                    <div className="p-5">
                                        <Tab.Group>
                                            <Tab.List className="flex flex-wrap mt-3 border-b border-white-light dark:border-[#191e3a]">
                                                ...
                                                <Tab className="p-3.5 py-2 -mb-[1px] block pointer-events-none text-white-light dark:text-dark outline-hidden">Disabled</Tab>
                                            </Tab.List>
                                                ...
                                                <div className="p-5">
                                                    <Tab.Group>
                                                        <Tab.List className="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
                                                            ...
                                                            <Tab className="pointer-events-none -mb-[1px] block p-3.5 py-2 text-white-light outline-hidden dark:text-dark">Disabled</Tab>
                                                        </Tab.List>
                                                        <Tab.Panels className="text-sm">
                                                            <Tab.Panel>
                                                                <div className="active pt-5">
